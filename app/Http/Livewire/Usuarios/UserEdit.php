...
class UserEdit extends Component
{
    ...
    public $user_edit_id, $name, $username, $email, $role, $status, $password, $password_confirmation, $region;//son propiedades públicas que almacenan los datos del usuario que se está editando. 
