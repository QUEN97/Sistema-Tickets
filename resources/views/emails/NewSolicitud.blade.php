													...
													<table class="heading_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="padding-bottom:15px;padding-left:10px;padding-right:10px;padding-top:15px;text-align:center;width:100%;">
																<h2 style="margin: 0; color: #555555; direction: ltr; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 18px; font-weight: 700; letter-spacing: normal; line-height: 200%; text-align: center; margin-top: 0; margin-bottom: 0;"><span style="color: #000100;"><strong><span class="tinyMce-placeholder">Nueva Solicitud de Productos</span></strong></span></h2>
															</td>
														</tr>
													</table>
												</td>
																	...
																	<p style="margin: 0;">
                                                                        <span style="color: #000100;">
                                                                            @if (Auth::user()->permiso_id == 2)
                                                                                {{ __('El Supervisor ') }} <strong>{{ $mailData['solicitadopor'] }}</strong> {{ __(' ha generado una nueva solicitud de productos') }}
                                                                            @elseif (Auth::user()->permiso_id == 3)
                                                                                {{ __('El Gerente ') }} <strong>{{ $mailData['solicitadopor'] }}</strong> {{ __(' ha generado una nueva solicitud de productos') }}
                                                                            @else
                                                                                <strong>{{ $mailData['solicitadopor'] }}</strong> {{ __(' ha generado una nueva solicitud de productos') }}
                                                                            @endif
                                                                        </span>
                                                                    </p>
																</div>
											...
											<tr>
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 5px; padding-bottom: 5px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
													<table class="heading_block block-1" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad">
																<h2 style="margin: 0; color: #555555; direction: ltr; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 18px; font-weight: 700; letter-spacing: normal; line-height: 200%; text-align: center; margin-top: 0; margin-bottom: 0;"><span style="color: #000100;"><strong><span class="tinyMce-placeholder">Productos Solicitados:</span></strong></span></h2>
															</td>
														</tr>
													</table>
												</td>
                                                                ...
                                                                <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;padding-top:5px;">
                                                                    <div class="alignment" align="center" style="line-height:10px">
                                                                        @if ($item->product_photo_path == null)
                                                                            <img src="{{ $message->embed(public_path('storage/product-photos/imagedefault.jpg'), $item->name) }}" style="display: block; height: auto; border: 0; width: 181px; max-width: 100%;" width="181" alt="{{ $item->name }}" title="{{ $item->name }}">
                                                                        @else
                                                                            <img src="{{ $message->embed(public_path('storage/'.$item->product_photo_path), $item->name) }}" style="display: block; height: auto; border: 0; width: 181px; max-width: 100%;" width="181" alt="{{ $item->name }}" title="{{ $item->name }}">
                                                                        @endif
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <td class="pad">
                                                                    <div style="font-family: sans-serif">
                                                                        <div class="txtTinyMce-wrapper" style="font-size: 12px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2;">
                                                                            <p style="margin: 0; font-size: 14px; text-align: center;"><span style="color:#000100;"><strong>{{ $item->name.(' ['.$item->id.']') }}</strong></span></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <table class="text_block block-5" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                            <tr>
                                                                <td class="pad" style="padding-bottom:5px;padding-left:10px;padding-right:10px;padding-top:5px;">
                                                                    <div style="font-family: sans-serif">
                                                                        <div class="txtTinyMce-wrapper" style="font-size: 12px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2;">
                                                                            <p style="margin: 0; font-size: 14px; text-align: left;"><strong><span style="color:#000100;">{{ __('Cantidad: ')}}</span></strong><span style="color:#000100;">{{ $item->pivot->cantidad }}</span></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <table class="text_block block-6" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                            <tr>
                                                                <td class="pad" style="padding-bottom:50px;padding-left:10px;padding-right:10px;padding-top:5px;">
                                                                    <div style="font-family: sans-serif">
                                                                        <div class="txtTinyMce-wrapper" style="font-size: 12px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2;">
                                                                            <p style="margin: 0; font-size: 14px; text-align: left;"><strong><span style="color:#000100;">{{ __('Unidad: ') }}</span></strong><span style="color:#000100;">{{ $item->unidad }}</span></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
														...
														<table class="text_block block-6" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                            <tr>
                                                                <td class="pad" style="padding-bottom:50px;padding-left:10px;padding-right:10px;padding-top:5px;">
                                                                    <div style="font-family: sans-serif">
                                                                        <div class="txtTinyMce-wrapper" style="font-size: 12px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2;">
                                                                            <p style="margin: 0; font-size: 14px; text-align: left;"><strong><span style="color:#000100;">{{ __('Motivo: ') }}</span></strong><span style="color:#000100;"> {{ $mailData['motivo'] }}</span></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
