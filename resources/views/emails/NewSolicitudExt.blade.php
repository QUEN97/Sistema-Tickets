	...
	<style>
		* {
		...
		@media (max-width:700px) {
			.row-6 .column-1 .block-2.image_block img {
			...
			.row-2 .column-2 .block-2.text_block td.pad {
				padding: 5px !important;
			}

			.row-6 .column-1 .block-2.image_block .alignment {
				...
				<td>
					<table class="row row-1" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #000000; background-size: auto;">
						<tbody>
							<tr>
								<td>
									<table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-size: auto; background-color: #000000; border-radius: 0; color: #000000; width: 680px;" width="680">
										<tbody>
											<tr>
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; background-color: #000000; vertical-align: top; padding-top: 5px; padding-bottom: 5px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
													<table class="image_block block-1" width="100%" border="0" cellpadding="20" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad">
																<div class="alignment" align="center" style="line-height:10px"><img src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/BeeProAgency/853076_837134/AbejaFullGas2.png" style="display: block; height: auto; border: 0; width: 150px; max-width: 100%;" width="150"></div>
															</td>
														</tr>
													</table>
												</td>
													...
													<table class="heading_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="padding-bottom:15px;padding-left:10px;padding-right:10px;padding-top:15px;text-align:center;width:100%;">
																<h2 style="margin: 0; color: #555555; direction: ltr; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 18px; font-weight: 700; letter-spacing: normal; line-height: 200%; text-align: center; margin-top: 0; margin-bottom: 0;">
                                                                    @foreach ($mailData['solicitudprodu'] as $item)
                                                                    <span style="color: #000100;"><strong><span class="tinyMce-placeholder">Nueva Solicitud Extraordinaria de {{ $item->tipo }}</span></strong></span>
                                                                    @endforeach
                                                                </h2>
															</td>
														</tr>
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-left:5px;padding-right:5px;padding-top:10px;">
																<div style="font-family: Arial, sans-serif">
																	<div class="txtTinyMce-wrapper" style="font-size: 12px; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
																		<p style="margin: 0; font-size: 15px; text-align: left; letter-spacing: normal;"><strong><span style="color:#000100;">Fecha de Solicitud:</span></strong></p>
																		<p style="margin: 0; font-size: 15px; text-align: left; letter-spacing: normal;"><span style="color:#000100;">{{ $mailData['fechaSolicitud'] }}</span></p>
																	</div>
																</div>
															</td>
														</tr>
																	...
																	<p style="margin: 0;">
                                                                        <span style="color: #000100;">
                                                                            @if (Auth::user()->permiso_id == 2)
                                                                                {{ __('El Supervisor ') }} <strong>{{ $mailData['solicitadopor'] }}</strong> {{ __(' ha generado una nueva solicitud para: ') }} @foreach ($mailData['solicitudprodu'] as $item) {{ $item->tipo }} @endforeach
                                                                            @elseif (Auth::user()->permiso_id == 3)
                                                                                {{ __('El Gerente ') }} <strong>{{ $mailData['solicitadopor'] }}</strong> {{ __(' ha generado una nueva solicitud para: ') }} @foreach ($mailData['solicitudprodu'] as $item) {{ $item->tipo }} @endforeach
                                                                            @else
                                                                                <strong>{{ $mailData['solicitadopor'] }}</strong> {{ __(' ha generado una nueva solicitud para: ') }}  @foreach ($mailData['solicitudprodu'] as $item) {{ $item->tipo }} @endforeach
                                                                            @endif
                                                                        </span>
                                                                    </p>
																</div>
													...
													<table class="text_block block-2" width="100%" border="0" cellpadding="15" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad">
																<div style="font-family: Arial, sans-serif">
																	<div class="txtTinyMce-wrapper" style="font-size: 12px; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
																		<p style="margin: 0; font-size: 15px; text-align: left; mso-line-height-alt: 22.5px; letter-spacing: normal;"><span style="font-size:15px;"><strong><span style="color:#000100;">{{ __('Estación: ') }}</span></strong><span style="color:#000100;">{{ $mailData['estaci'] }}</span></span></p>
																		<p style="margin: 0; font-size: 15px; text-align: left; mso-line-height-alt: 22.5px; letter-spacing: normal;"><span style="font-size:15px;"><strong><span style="color:#000100;">{{ __('No. de Solicitud: #')}}</span></strong><span style="color:#000100;">{{ $mailData['numSolici'] }}</span></span></p>
																		<p style="margin: 0; font-size: 15px; text-align: left; mso-line-height-alt: 22.5px; letter-spacing: normal;"><span style="font-size:15px;"><strong><span style="color:#000100;">{{ __('Categoría: ')}}</span></strong><span style="color:#000100;">{{ $mailData['categ'] }}</span></span></p>
																	</div>
																</div>
															</td>
														</tr>
											...
											<tr>
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 5px; padding-bottom: 5px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
													<table class="heading_block block-1" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad">
																<h2 style="margin: 0; color: #555555; direction: ltr; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 18px; font-weight: 700; letter-spacing: normal; line-height: 200%; text-align: center; margin-top: 0; margin-bottom: 0;"><span style="color: #000100;"><strong><span class="tinyMce-placeholder">
                                                                    @foreach ($mailData['solicitudprodu'] as $item) {{ $item->tipo }} @endforeach Solicitados:</span></strong></span>
                                                                </h2>
															</td>
														</tr>
													</table>
                                                ...
                                                <tr>
                                                            ...
                                                            <tr>
                                                                <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;padding-top:5px;">
                                                                    <div class="alignment" align="center" style="line-height:10px">
                                                                            <img src="{{ $message->embed(public_path('storage/product-photos/imagedefault.jpg'), $item->producto_extraordinario) }}" style="display: block; height: auto; border: 0; width: 181px; max-width: 100%;" width="181" alt="{{ $item->producto_extraordinario }}" title="{{ $item->producto_extraordinario }}">
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    ...
                                                    <td class="column column-2" width="66.66666666666667%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
                                                                ...
                                                                <td class="pad">
                                                                    <div style="font-family: sans-serif">
                                                                        <div class="txtTinyMce-wrapper" style="font-size: 12px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2;">
                                                                            <p style="margin: 0; font-size: 14px; text-align: center;"><span style="color:#000100;"><strong>{{ $item->producto_extraordinario }}</strong></span></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <table class="text_block block-5" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                            <tr>
                                                                <td class="pad" style="padding-bottom:5px;padding-left:10px;padding-right:10px;padding-top:5px;">
                                                                    <div style="font-family: sans-serif">
                                                                        <div class="txtTinyMce-wrapper" style="font-size: 12px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2;">
                                                                            <p style="margin: 0; font-size: 14px; text-align: left;"><strong><span style="color:#000100;">{{ __('Cantidad: ')}}</span></strong><span style="color:#000100;">{{ $item->cantidad }}</span></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <table class="text_block block-6" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                            <tr>
                                                                <td class="pad" style="padding-bottom:50px;padding-left:10px;padding-right:10px;padding-top:5px;">
                                                                    <div style="font-family: sans-serif">
                                                                        <div class="txtTinyMce-wrapper" style="font-size: 12px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2;">
                                                                            <p style="margin: 0; font-size: 14px; text-align: left;"><strong><span style="color:#000100;">{{ __('Motivo: ') }}</span></strong>
                                                                                <span style="color:#000100;">
                                                                                    {{ $mailData['motivo'] }}
                                                                                </span></p>
                                                                        </div>
													...
													<table class="image_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;padding-top:5px;padding-bottom:5px;">
																<div class="alignment" align="center" style="line-height:10px"><img src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/BeeProAgency/853076_837134/AbejaFullGas2.png" style="display: block; height: auto; border: 0; width: 193px; max-width: 100%;" width="193" alt="FullGas El Buen Trato se Contagia" title="FullGas El Buen Trato se Contagia"></div>
															</td>
														</tr>
													</table>
												</td>
															...
															<td class="pad">
																<div style="font-family: Arial, sans-serif">
																	<div class="txtTinyMce-wrapper" style="font-size: 12px; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #000000; line-height: 1.2;">
																		<p style="margin: 0; font-size: 16px; text-align: left;"><span style="color:#fffeff;"><strong>POR FAVOR NO RESPONDAS A ESTE CORREO:</strong></span></p>
																	</div>
																</div>
															</td>
														</tr>
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-left:5px;padding-right:5px;padding-top:5px;">
																<div style="color:#000000;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:15px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:18px;">
																	<p style="margin: 0;"><span style="color: #fffeff;"><strong>Para informes de </strong><span style="color: #fffeff;"><strong>facturación</strong></span><strong>: facturacion@fullgas.com.mx</strong></span><br><span style="color: #fffeff;"><strong>Para Sistemas: sistemas@fullgas.com.mx</strong></span><br><span style="color: #fffeff;"><strong>Quedamos a sus ordenes...</strong></span></p>
																</div>
															</td>
														</tr>
													</table>
