            ...
            <tr>
                <td>
                    <table class="row row-1" align="center" width="100%" border="0" cellpadding="0"
                        ...
                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #000000; background-size: auto;">
                        <tbody>
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        cellspacing="0" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-size: auto; background-color: #000000; border-radius: 0; color: #000000; width: 680px;"
                                        width="680">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" width="100%"
                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; background-color: #000000; vertical-align: top; padding-top: 5px; padding-bottom: 5px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
                                                            ...
                                                            <td class="pad">
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px"><img
                                                                        src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/BeeProAgency/853076_837134/AbejaFullGas2.png"
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        cellspacing="0" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-radius: 0; color: #000000; width: 680px;"
                                        width="680">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" width="75%"
                                                    ...
                                                    <table class="heading_block block-2" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:15px;padding-left:10px;padding-right:10px;padding-top:15px;text-align:center;width:100%;">
                                                                <h2
                                                                    ...
                                                                    @foreach ($mailData['solicitudprodu'] as $item)
                                                                        <span style="color: #000100;"><strong><span
                                                                                    class="tinyMce-placeholder">Nueva
                                                                                    Solicitud Extraordinaria de
                                                                                    {{ $item->tipo }}</span></strong></span>
                                                                    @endforeach
                                                                </h2>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div style="font-family: Arial, sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 15px; text-align: left; letter-spacing: normal;">
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 15px; text-align: left; letter-spacing: normal;">
                                                                            <span
                                                                                style="color:#000100;">{{ $mailData['fechaSolicitud'] }}</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;">
                                                                        <span style="color: #000100;">
                                                                                {{ __('El Supervisor ') }}
                                                                                <strong>{{ $mailData['solicitadopor'] }}</strong>
                                                                                {{ __(' ha generado una nueva solicitud de: ') }}
                                                                                @foreach ($mailData['solicitudprodu'] as $item)
                                                                                    {{ $item->tipo }}
                                                                                @endforeach
                                                                        </span>
                                                                    ...
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:15px;"><strong><span
                                                                                        style="color:#000100;">{{ __('Estación: ') }}</span></strong><span
                                                                                    style="color:#000100;">{{ $mailData['estaci'] }}</span></span>
                                                                        </p>
                                                                        <p
                                                                            style="margin: 0; font-size: 15px; text-align: left; mso-line-height-alt: 22.5px; letter-spacing: normal;">
                                                                            <span style="font-size:15px;"><strong><span
                                                                                        style="color:#000100;">{{ __('No. de Solicitud: #') }}</span></strong><span
                                                                                    style="color:#000100;">{{ $mailData['numSolici'] }}</span></span>
                                                                        </p>
                                                                        <p
                                                                            style="margin: 0; font-size: 15px; text-align: left; mso-line-height-alt: 22.5px; letter-spacing: normal;">
                                                                            <span style="font-size:15px;"><strong><span
                                                                                        style="color:#000100;">{{ __('Categoría: ') }}</span></strong><span
                                                                                    style="color:#000100;">{{ $mailData['categ'] }}</span></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="column column-1" width="33.333333333333336%"
                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
                                                        <table class="image_block block-2" width="100%"
                                                            ...
                                                            <tr>
                                                                <td class="pad"
                                                                    ...
                                                                    <div class="alignment" align="center"
                                                                        ...
                                                                        <img src="{{ $message->embed(public_path('storage/product-photos/imagedefault.jpg'), $item->producto_extraordinario) }}"
                                                                            style="display: block; height: auto; border: 0; width: 181px; max-width: 100%;"
                                                                            width="181"
                                                                            alt="{{ $item->producto_extraordinario }}"
                                                                            title="{{ $item->producto_extraordinario }}">
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    ...
                                                    <td class="column column-2" width="66.66666666666667%"
                                                                    ...
                                                                    <div style="font-family: sans-serif">
                                                                        <div class="txtTinyMce-wrapper"
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                <span
                                                                                    style="color:#000100;"><strong>{{ $item->producto_extraordinario }}</strong></span>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                        ...
                                                        <table class="divider_block block-4" width="100%"
                                                            border="0" cellpadding="10" cellspacing="0"
                                                            role="presentation"
                                                            style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                                            <tr>
                                                        ...
                                                        <table class="text_block block-5" width="100%"
                                                            border="0" cellpadding="0" cellspacing="0"
                                                            role="presentation"
                                                            style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                            <tr>
                                                                    ...
                                                                    <div style="font-family: sans-serif">
                                                                        <div class="txtTinyMce-wrapper"
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                <strong><span
                                                                                        style="color:#000100;">{{ __('Cantidad: ') }}</span></strong><span
                                                                                    style="color:#000100;">{{ $item->cantidad }}</span>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                        ...
                                                        <table class="text_block block-6" width="100%"
                                                            border="0" cellpadding="0" cellspacing="0"
                                                            role="presentation"
                                                            style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                            <tr>
                                                                <td class="pad"
                                                                    style="padding-bottom:50px;padding-left:10px;padding-right:10px;padding-top:5px;">
                                                                    <div style="font-family: sans-serif">
                                                                        <div class="txtTinyMce-wrapper"
                                                                            style="font-size: 12px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2;">
                                                                            <p
                                                                                style="margin: 0; font-size: 14px; text-align: left;">
                                                                                <strong><span
                                                                                        style="color:#000100;">{{ __('Motivo: ') }}</span></strong>
                                                                                <span style="color:#000100;">
                                                                                    {{ $mailData['motivo'] }}
                                                                                </span>
                                                                            </p>
                                            ...
                                            <tr>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px"><img
                                                                        ...
                                                                        width="193"
                                                                        alt="FullGas El Buen Trato se Contagia"
                                                                        title="FullGas El Buen Trato se Contagia">
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td class="column column-2" width="66.66666666666667%"
                                                                ...
                                                                <div style="font-family: Arial, sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="color:#fffeff;"><strong>POR
                                                                                    FAVOR NO RESPONDAS A ESTE
                                                                                    CORREO:</strong></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <table class="paragraph_block block-4" width="100%"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:10px;padding-left:5px;padding-right:5px;padding-top:5px;">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;"><span
                                                                            style="color: #fffeff;"><strong>Para
                                                                                informes de </strong><span
                                                                                style="color: #fffeff;"><strong>facturación</strong></span><strong>:
                                                                                facturacion@fullgas.com.mx</strong></span><br><span
                                                                            style="color: #fffeff;"><strong>Para
                                                                                Sistemas:
                                                                                sistemas@fullgas.com.mx</strong></span><br><span
                                                                            style="color: #fffeff;"><strong>Quedamos a
                                                                                sus ordenes...</strong></span></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
