                            ...
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        cellspacing="0" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-size: auto; background-color: #000; border-radius: 0; color: #000; width: 680px; margin: 0 auto;"
                                        width="680">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" width="100%"
                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; background-color: #000000; padding-bottom: 5px; padding-top: 5px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
                                                            ...
                                                            <td class="pad">
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px"><img
                                                                        src="https://0eff0a3e54.imgdist.com/public/users/Integrators/BeeProAgency/853076_837134/FullGas_rojo2.png"
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        cellspacing="0" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-radius: 0; color: #000; width: 680px; margin: 0 auto;"
                                        width="680">
                                        <tbody>
                                            <tr>
                                                                ...
                                                                <div style="font-family: Arial, sans-serif">
                                                                    <div class
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 15px; text-align: left; mso-line-height-alt: 22.5px; letter-spacing: normal;">
                                                                            <span
                                                                                style="color:#000100;">{{ $mailDataU['fechaSolicitud'] }}</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; margin-bottom: 16px;"><span
                                                                            style="color: #000100;">Buen día Lic. <span
                                                                                style="color: #000000;"><strong>REYES</strong></span></span>
                                                                    </p>
                                                                    <p style="margin: 0;"><span
                                                                            style="color: #000100;"><span
                                                                                style="color: #000000;">Anexo la
                                                                ...
                                                                <div style="font-family: Arial, sans-serif">
                                                                    <div class
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <strong>SOLICITADO:&nbsp;</strong>{{ $mailDataU['solicitadopor'] }}
                                                                        </p>
                                                                        <p
                                                                            style="margin: 0; mso-line-height-alt: 18px; letter-spacing: normal;">
                                                                            <strong>ÁREA DEL
                                                                                SOLICITANTE:&nbsp;</strong>{{ $mailDataU['areacliente'] }}
                                                                        </p>
                                                                        <p
                                                                            style="margin: 0; mso-line-height-alt: 18px; letter-spacing: normal;">
                                                                            <strong>VERIFICADO:&nbsp;</strong>{{ $mailDataU['verificadopor'] }}
                                                                        </p>
                                                                        <p
                                                                            style="margin: 0; mso-line-height-alt: 18px; letter-spacing: normal;">
                                                                            <strong>TICKET: <a
                                                                ...
                                                                <div style="font-family: Arial, sans-serif">
                                                                    <div class
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; mso-line-height-alt: 18px; letter-spacing: normal;">
                                                                            <strong>PROBLEMA
                                                                                DETECTADO:</strong>{{ $mailDataU['problema'] }}
                                                                        </p>
                                                                        <p
                                                                            style="margin: 0; mso-line-height-alt: 18px; letter-spacing: normal;">
                                                                            &nbsp;</p>
                                                ...
                                                <td class="column column-1" width="100%"
                                                    ...
                                                    <table class="paragraph_block block-1" width="100%"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    style="color:#101112;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:13px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:15.6px;">
                                                                    <p style="margin: 0; margin-bottom: 16px;"><span
                                                                            style="color: #ffffff;"><strong>POR FAVOR
                                                                                NO RESPONDAS A ESTE
                                                                                CORREO</strong></span></p>
                                                                    <p style="margin: 0;"><span
                                                                            style="color: #ffffff;"><strong>Quedamos a
                                                                                sus ordenes:
                                                                                sistemas@fullgas.com.mx</strong></span>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table class="image_block block-2" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad" style="width:100%;">
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px"><img
                                                                        src="https://0eff0a3e54.imgdist.com/public/users/Integrators/BeeProAgency/853076_837134/fullpower.png"
                                                                        style="display: block; height: auto; border: 0; max-width: 680px; width: 100%;"
                                                                        width="680"></div>
                                                            </td>
                                                        </tr>
                                                    </table>
