<x-app-layout>
    @section('title', 'Fallas Eliminadas')
    <x-slot name="header">
        <div>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('FALLAS ELIMINADAS') }}
            </h2>
        </div>
    </x-slot>
    <div class="content">
                                    ...
                                    @foreach ($trashed as $falla)
                                        <tr
                                            ...
                                            <td
                                                ...
                                                <div class="text-sm">
                                                    <div class="font-medium text-gray-700 uppercase">  {{$falla->name}}</div>
                                                </div>
                                            </td>
                                            ...
                                            <td
                                                ...
                                                <div class="grid grid-cols-1">
                                                    <div>
                                                        {{-- restaurar --}}
                                                        <form method="POST" action="{{ route('fallas_restore') }}"
                                                            onsubmit="return confirm('Restaurar Falla');">
                                                            {{ csrf_field() }}
                                                            <input type="hidden" name="id"
                                                                value="{{ $falla->id }}" required />
                                                            <button type="submit">
