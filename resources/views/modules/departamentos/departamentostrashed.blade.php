                                    ...
                                    @foreach ($trashed as $depar)
                                        <tr
                                            ...
                                            <td
                                                ...
                                                <div class="text-sm">
                                                    <div class="font-medium text-gray-700 uppercase">{{$depar->name}}</div>
                                                </div>
                                            </td>
                                                ...
                                                <div class="grid grid-cols-1">
                                                    ...
                                                    <div>
                                                        ...
                                                        <form method="POST" action="{{ route('departamento_restore') }}"
                                                            onsubmit="return confirm('Restaurar Departamento');">
                                                            {{ csrf_field() }}
                                                            <input type="hidden" name="id"
                                                                value="{{ $depar->id }}" required />
                                                            <button type="submit">
                                    ...
                                    <tr>
                                        <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b  block lg:table-cell relative lg:static"
                                            ...
                                            <span
                                                ...
                                                registros</span>
                                            {{ __('No hay departamentos eliminados') }}
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
