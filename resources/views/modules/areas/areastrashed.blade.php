                                    ...
                                    @foreach ($trashed as $area)
                                        <tr
                                            ...
                                            <td
                                                ...
                                                <div class="text-sm">
                                                    <div class="font-medium text-gray-700 uppercase">{{$area->name}}</div>
                                                </div>
                                            </td>
                                            ...
                                            <td
                                                ...
                                                <div class="grid grid-cols-1">
                                                    ...
                                                    <div>
                                                        {{-- restaurar --}}
                                                        <form method="POST" action="{{ route('area_restore') }}"
                                                            onsubmit="return confirm('Restaurar Área');">
                                                            {{ csrf_field() }}
