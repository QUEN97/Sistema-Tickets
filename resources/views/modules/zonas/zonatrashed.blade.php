<x-app-layout>
    @section('title', 'Zonas Eliminadas')
    <x-slot name="header">
        <div>
                                            ...
                                            <td
                                                ...
                                                <div class="grid grid-cols-2">
                                                    <div>
                                                        ...
                                                        <form method="POST" action="{{ route('zona_restore') }}"
                                                            onsubmit="return confirm('Restaurar Zona');">
                                                            {{ csrf_field() }}
                                                            <input type="hidden" name="id"
                                                                value="{{ $zona->id }}" required />
                                                            <button type="submit">
