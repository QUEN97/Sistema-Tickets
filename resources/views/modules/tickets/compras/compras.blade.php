                ...
                @if (Auth::user()->permiso_id == 1 ||
                    ...
                    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-center mt-5">
                        <div class="flex justify-center rounded-lg" role="group">
                            @if (Auth::user()->permiso_id == 1)
                                <a class="tooltip" href="{{ route('tck.editar', $ticketID) }}">
                            ...
                            @endif
                            <a class="tooltip" href="{{ route('tck.tarea', $ticketID) }}">
                                @if ($tareasCount)
                                    <div class="relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor"
                            ...
                            <a class=" tooltip" href="{{ route('tck.ver', $ticketID) }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="6" height="6"
                                    fill="currentColor" class="w-6 h-6 text-black hover:text-indigo-600 dark:text-white"
                                    viewBox="0 0 576 512">
                                    <path
