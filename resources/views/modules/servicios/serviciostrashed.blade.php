                                    ...
                                    @foreach ($trashed as $servicio)
                                        <tr
                                            ...
                                            <td
                                                ...
                                                <div class="text-sm">
                                                    <div class="font-medium text-gray-700 uppercase">{{$servicio->name}}</div>
                                                </div>
                                            </td>
                                            ...
                                            <td
                                                ...
                                                <div class="grid grid-cols-1">
                                                    ...
                                                    <div>
                                                        {{-- restaurar --}}
                                                        <form method="POST" action="{{ route('servicios_restore') }}"
                                                            onsubmit="return confirm('Restaurar Servicio');">
                                                            {{ csrf_field() }}
                                    ...
                                    <tr>
                                        <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b  block lg:table-cell relative lg:static"
                                            ...
                                            <span
                                                ...
                                                registros</span>
                                            {{ __('No hay servicios eliminados') }}
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
