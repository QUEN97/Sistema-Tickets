<x-app-layout>
    @section('title', 'Tipos Eliminadas')
    <x-slot name="header">
        <div>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('TIPOS DE TICKET ELIMINADOS') }}
            </h2>
        </div>
    </x-slot>
    <div class="content">
                                    ...
                                    @foreach ($trashed as $tipo)
                                        <tr
                                            ...
                                            <td
                                                ...
                                                <div class="text-sm">
                                                    <div class="font-medium text-gray-700 uppercase">{{ $tipo->name }}</div>
                                                </div>
                                            </td>
                                    ...
                                    <tr>
                                        <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b  block lg:table-cell relative lg:static"
                                            ...
                                            <span
                                                ...
                                                registros</span>
                                            {{ __('No hay tipos de ticket eliminados') }}
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
