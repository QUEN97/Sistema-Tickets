                    ...
                    <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5 mt-12">
                        <table class="border-collapse w-full bg-white text-center text-sm text-gray-500">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th
                                        class="p-3 font-bold uppercase text-center bg-gray-200 text-gray-600 border border-gray-300 hidden lg:table-cell">
                                        Nombre</th>
                                    <th
                                        class="p-3 font-bold uppercase text-center bg-gray-200 text-gray-600 border border-gray-300 hidden lg:table-cell">
                                        Categoria</th>
                                    ...
                                    @foreach ($trashed as $producto)
                                        <tr
                                            ...
                                            <td
                                                class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b  block lg:table-cell relative lg:static">
                                                <span
                                                    class="lg:hidden absolute top-0 left-0 bg-blue-200 px-2 py-1 text-xs font-bold uppercase">Unidad</span>
                                                {{ $producto->unidad }}
                                            </td>
                                            ...
                                            <td
                                                ...
                                                <div class="grid grid-cols-1">
                                                    <div>
                                                        ...
                                                        {{-- restaurar --}}
                                                        <form method="POST" action="{{ route('producto_restore') }}"
                                                            onsubmit="return confirm('Restaurar Producto');">
                                                            {{ csrf_field() }}
                                                            <input type="hidden" name="id"
                                                                value="{{ $producto->id }}" required />
                                                            <button type="submit">
                                                    ...
                                                    <div>
                                                        {{-- Eliminar Permanente --}}
                                                        {{-- <form method="POST"
                                                            action="{{ route('deleteproducto_permanently') }}"
                                    ...
                                    <tr>
                                        <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b  block lg:table-cell relative lg:static"
                                            ...
                                            <span
                                                ...
                                                registros</span>
                                            {{ __('No hay productos eliminados') }}
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
