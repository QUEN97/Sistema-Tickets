                ...
                <tbody>
                    @foreach ($servicios as $servicio)
                        <tr
                            ...
                            <th
                                class="w-full font-medium text-sm lg:w-auto p-3 text-gray-800 border border-b dark:text-gray-400  dark:border-gray-700">
                                <div class="w-full flex justify-center gap-2">
                                    @if ($valid->pivot->ed == 1)
                                        @livewire('productos.existencias.edit-servicio', ['servicioID' => $servicio->id])
                                    @endif
                                    @if ($valid->pivot->de == 1)
                                        @livewire('productos.existencias.delete-servicio', ['servicioID' => $servicio->id])
                                    @endif
                                </div>
                            </th>
                        </tr>
