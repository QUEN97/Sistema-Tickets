<x-app-layout>
    @section('title', 'Marcas Eliminadas')
    <x-slot name="header">
        <div>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('MARCAS ELIMINADAS') }}
            </h2>
        </div>
    </x-slot>
    <div class="content">
                                        ...
                                        <tr
                                            ...
                                            <td
                                                ...
                                                <div class="grid grid-cols-1">
                                                    <div>
                                                        {{-- restaurar --}}
                                                        <form method="POST" action="{{ route('marca_restore') }}"
                                                            onsubmit="return confirm('Restaurar Marca');">
                                                            {{ csrf_field() }}
                                                            <input type="hidden" name="id"
                                                                value="{{ $marca->id }}" required />
                                                            <button type="submit">
