                ...
                <x-slot name="body">
                    @forelse($regiones as $region)
                        ...
                        <x-row wire:loading.class.delay="opacity-75">
                            ...
                            <x-cell class="font-bold">{{ $region->name }}</x-cell>
                            <x-cell>
                                <span
                            ...
                            <div class="relative inline-block text-left">
                                ...
                                <div x-show="open" @click.away="open = false"
                                    ...
                                    <div class="flex gap-2 justify-center items-center">
                                        @if ($valid->pivot->vermas == 1)
                                    <div>
                                        @livewire('regiones.edit-region',['regionID'=>$region->id], key('edit' . $region->id))
                                    </div>
                                    @endif
                                    @if ($valid->pivot->ed == 1)
                                    <div>
                                        @livewire('regiones.delete-region',['regionID'=>$region->id], key('delete' . $region->id))
                                    </div>
                                    @endif
                                    </div>
                                </div>
