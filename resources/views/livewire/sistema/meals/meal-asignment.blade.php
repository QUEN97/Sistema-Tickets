    ...
    <x-slot name="content">
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <span
                                                ...
                                                {{ \Carbon\Carbon::parse($horario->meal->start_time)->format('g:i A') }} - {{ \Carbon\Carbon::parse($horario->meal->end_time)->format('g:i A') }}
                                        </td>
                                        <td
                                            class="w-full lg:w-auto p-3 text-gray-800  dark:text-white border border-b block lg:table-cell relative lg:static">
                                            <span
        ...
        <x-dialog-modal wire:model="AsignacionHorario" class="flex items-center">
            ...
            <x-slot name="content">
             ...
             <div class="flex gap-2 mt-2">
                <div class="md:w-1/2 px-3 mb-6 md:mb-2">
                    ...
                    <select id="selectedMealSchedule"  class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm1 dark:border-gray-600 dark:bg-dark-eval-1
                    dark:text-gray-300 dark:focus:ring-offset-dark-eval-1" wire:model="selectedMealSchedule">
                ...
                <div class="md:w-1/2 px-3 mb-6 md:mb-2">
                    ...
                    <select id="selectedUser"  class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm1 dark:border-gray-600 dark:bg-dark-eval-1
                    dark:text-gray-300 dark:focus:ring-offset-dark-eval-1" wire:model="selectedUser">
            ...
            <x-slot name="footer">
                ...
                <x-button variant="danger" class="ml-2" wire:click="assignMealSchedule" wire:loading.attr="disabled">
