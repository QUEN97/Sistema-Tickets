                            ...
                            <div class="flex">
                                @if (isset($notification->data['photo']))
                                    ...
                                    <img class="h-10 w-10 rounded-full object-cover"
                                        src="{{ $notification->data['photo'] }}" alt="{{ $notification->data['user'] }}">
                                @endif
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        @if ($notification->read_at != null)
                                            <svg width="20" height="20" viewBox="0 0 32 32"
                                                xmlns="http://www.w3.org/2000/svg" class="text-blue-400 items-end">
                                    ...
                                    <div class="flex items-center mt-3 mb-3">
                                        <div class="relative" x-data="{ toggle: false }">
                                            ...
                                            <div class="absolute z-50 flex flex-col w-max rounded-md overflow-hidden bg-white p-1 dark:bg-dark-eval-3 shadow-md top-0 right-full"
                                                ...
                                                <button
                                                    wire:click="deleteNotification('{{ $notification->id }}')">eliminar</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
