<div class="bg-white dark:bg-dark-eval-1 rounded-xl p-4 shadow-xl ">
    <div class="flex flex-col justify-center items-center">
        <a href="{{ asset('img/icons/Imagen2.png') }}" target="_blank">
            <img src="{{ asset('img/icons/Imagen2.png') }}" class="rounded-lg" style="width: 300px; height:200px; position:relative;"  />
        </a>
    </div>
    ...
    <div class=" rounded-lg overflow-hidden ">
        <details>
            <summary
                ...
                {{ __('MOSTRAR/OCULTAR') }}<span class="inline-flex items-center justify-center w-4 h-4 ml-2 text-xs font-semibold text-blue-800 bg-blue-200 rounded-full" >{{ $ultimosCerrados->count() }}</span>
            </summary>
            <table
