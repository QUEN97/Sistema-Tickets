<div class="bg-white dark:bg-dark-eval-1 rounded-xl p-4 shadow-xl mt-">
    <div class="flex flex-col justify-center items-center">
        <a href="{{ asset('img/icons/Imagen3.png') }}" target="_blank">
            <img src="{{ asset('img/icons/Imagen3.png') }}" class="rounded-lg" style="width: 300px; height:200px; position:relative;" />
        </a>
    </div>
    ...
    <div class=" rounded-lg overflow-hidden max-h-[320px] overflow-y-auto">
        <details>
            <summary class="bg-gray-100 dark:bg-dark-eval-2 py-2 px-4 cursor-pointer text-center">
                {{ __('MOSTRAR/OCULTAR') }}<span class="inline-flex items-center justify-center w-4 h-4 ml-2 text-xs font-semibold text-blue-800 bg-blue-200 rounded-full" >{{ $ultimosEnProceso->count() }}</span>
            </summary>
            <table
