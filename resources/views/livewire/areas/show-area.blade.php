<div>
    <button wire:click="showArea({{$areaID}})" wire:loading.attr="disabled" class="tooltip">
                    ...
                    <div>
                        @if ($users)
                            <div>
                                ...
                                <div class="text-lg">{{$users->count()}}</div>
                            </div>
                        @endif
                    </div>
                @endif
            ...
            @if ($users)
                @if ($users->count() > 0)
                    <div class="border rounded-lg  max-h-[320px] overflow-auto dark:border-gray-700">
                        <details>
                            <summary class="bg-gray-100 py-2 px-4 cursor-pointer dark:bg-slate-700 dark:text-gray-300 dark:border-gray-700">Click para mostrar/ocultar Usuarios en el área</summary>
                            <table class="w-full">
                                <thead>
                                    <tr>
                ...
                <div class="flex flex-col justify-center items-center gap-3 py-6 text-gray-400">
                    ...
                    <span class="text-lg">Sin usuarios asignados</span>
                </div>
                @endif
            @endif
