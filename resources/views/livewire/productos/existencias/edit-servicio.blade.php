<div x-data="{ modelOpen: false }">
    <div class="">
        <button @click="modelOpen =!modelOpen" wire:loading.attr="disabled" aria-label="editar ticket" class="tooltip">
        ...
        <div class="flex items-center justify-center min-h-screen px-4 text-center md:items-center sm:p-0">
            ...
            >
                ...
                <div name="footer" class="d-none text-right mt-1">
                    <x-danger-button class="mr-2" wire:click="updateServicio({{$servicioID}})" wire:loading.attr="disabled">
                        <div role="status" wire:loading wire:target="updateServicio">
