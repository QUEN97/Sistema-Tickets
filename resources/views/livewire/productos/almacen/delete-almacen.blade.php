                ...
                <div x-cloak x-show="modelOpen" 
                    ...
                    <div>
                        <div class=" text-center text-base">
                            ...
                            <span>¿Está seguro de eliminar <i>"{{$name}}"</i> ?</span>
                        </div>
                        <div name="footer" class="d-none text-right mt-1">
                            <x-danger-button class="mr-2" wire:click="deleteAlma({{$idAlma}})" wire:loading.attr="disabled">
                                <div role="status" wire:loading wire:target="deleteAlma">
