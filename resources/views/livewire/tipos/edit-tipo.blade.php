<div>
    <button wire:click="editTipo({{$tipoID}})" wire:loading.attr="disabled" class="tooltip">
        ...
        <x-dialog-modal wire:model="modal" id="modalRepuesto" class="flex items-center">
            ...
            <x-slot name="footer" class="d-none">
                <x-danger-button class="mr-2" wire:click="updateTipo({{$tipoID}})" wire:loading.attr="disabled">
                    Aceptar
                </x-danger-button>
