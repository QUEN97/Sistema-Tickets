                            ...
                            <div x-show="isOpen" @click.away="isOpen = false"
                                ...
                                <div class="flex flex-col justify-center items-center">
                                    @if ($ticket->status != 'Cerrado')
                                        @if (Auth::user()->permiso_id == 1)
                                            <div class="flex gap-1">
                                                <a href="{{ route('tck.editar', $ticket->id) }}" :key="'edittck-'.$ticket->id">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                        viewBox="0 0 24 24" stroke-width="1.5"
                                                        stroke="currentColor"
                                                        class="w-6 h-6 text-black hover:text-gray-600 dark:text-gray-400">
                                        ...
                                        @endif
                                        <div class="flex gap-1">
                                            <a href="{{ route('tck.ver', $ticket->id) }}" :key="'vertck-'.$ticket->id">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="15"
                                                    height="15" fill="currentColor"
                                                    class="w-6 h-6 text-black hover:text-gray-600 dark:text-gray-400"
                                                    viewBox="0 0 576 512">
                                        ...
                                        @if (!in_array(Auth::user()->permiso_id, [2, 3, 6]))
                                            ...
                                            <div class="flex gap-1">
                                                <a href="{{ route('tck.tarea', $ticket->id) }}" :key="'tareatck-'.$ticket->id">
                                                    @if ($ticket->tareas->count())
                                                        <div class="relative">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                fill="none" viewBox="0 0 24 24"
