        ...
        <x-slot name="content">
            <div class="flex flex-wrap gap-3 justify-evenly items-center">
                        ...
                        <div>
                            ...
                            <select id="area" name="area" class="border-gray-300 rounded-md dark:bg-slate-800 dark:border-gray-700" wire:model="area">
            ...
            <div class="flex flex-wrap gap-2">
                <div class="w-full">
                    ...
                    <x-input wire:model="asunto" type="text" name="asunto"
                        id="asunto" class="w-full" required autofocus autocomplete="asunto" />
