<div>
            ...
            @if ($comentarios->count() > 0)
                <div class="max-h-[200px] overflow-auto mt-4">
                    <x-label value="{{ __('Comentarios registrados') }}" class="border-b border-gray-400 w-full text-left mb-2"/>
                    <div class="flex flex-col gap-3 py-2">
                        @foreach ($comentarios as $comentario)
                            <div class="relative">
                                ...
                                <button type="button" class="absolute top-2 right-2" wire:click="removeCom({{$comentario->id}})" data-bs-toggle="tooltip" data-bs-placement="top" title="Doble click para Eliminar">
