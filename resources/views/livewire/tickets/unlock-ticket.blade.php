<div>
    <button wire:click="$set('modal',true)" wire:loading.attr="disabled" class="bg-white dark:bg-dark-eval-3 p-1 rounded-md tooltip">
        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-lock-open h-6 w-6  hover:text-indigo-500 transition duration-300" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
