<div>
    <button wire:click="showServicio({{$servicioID}})" wire:loading.attr="disabled" class="tooltip">
        ...
        @if ($servicio)
            <div class=" flex justify-evenly pb-4">
                    <div>
                        ...
                        <div class="text-lg">{{$servicio->name}}</div>
                    </div>
                    <div>
                        <div>
                            <h2>Fallas asignadas al servicio:</h2>
                            <div class="text-lg">{{$servicio->fallas->count()}}</div>
                        </div>
                    </div>
