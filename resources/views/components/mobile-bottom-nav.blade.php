<div class="fixed inset-x-0 bottom-0 flex items-center justify-between px-4 py-4 sm:px-6 transition-transform duration-500 bg-transparent md:hidden dark:bg-transparent"
:class="{
    '-translate-x-full': scrollingDown,
    'translate-x-0': scrollingUp,
}">
