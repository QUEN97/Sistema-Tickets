...
<table style="border-collapse:collapse;">   
    <thead>
        <tr>
            <th colspan="7" style="background-color: #c90000; color:white;">Salida #{{$salida->id}}</th>
            
        </tr>
        <tr>
            <th colspan="7" style="background-color: #c90000; color:white;border:2px;">Motivo: {{$salida->motivo}}</th>
